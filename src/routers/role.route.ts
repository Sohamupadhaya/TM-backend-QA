...
router.post("/add-roles", authentication, checkPermission("add","role"), catchAsync(addRole));
router.get("/get-all-role-of-company", authentication, checkPermission("getAll","role"), catchAsync(getAllRoleOfCompany));
